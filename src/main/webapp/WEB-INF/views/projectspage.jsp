		...
		<table class="content-table">
			...
			<c:forEach var="project" items="${requestScope.projects}">
				...
				<tr>
					...
					<form action="/smartmanager/projectUpdated.htm" method="get">
						<input type="hidden" id="a" name="pname"/>
						<input type="hidden" id="b" name="pstartdate" />
						<input type="hidden" id="c" name="penddate" /> 
						<input type="submit" class="minus"  value="✔" />
					</form></td>
				</tr>
